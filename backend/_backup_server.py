...
class TeamConfig(BaseModel):
    size: int
    control: str # "player", "unified", "random"
...
def create_game(config: GameConfig):
    ...
    return {"session_id": session_id, "message": "Game created"}
...
def submit_action(req: ActionRequest):
    ...
    # Process turn with player action
    # For now, we assume turn-based lockstep
